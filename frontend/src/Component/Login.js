      ...
      try {
        ...
        if (response.data) {
          ...
          Swal.fire({
            ...
            title: "Đăng Nhập Không Thành Công", // Tiêu đề thông báo
            text: "Vui lòng thử lại.", // Nội dung thông báo
            confirmButtonText: "OK", // Nội dung nút bấm
          });
        }
      } catch (error) {
        if (error.response) {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <video
        ...
        muted
      >
        <source src={require("../assets/img/Loginpage.mp4")} type="video/mp4" />
      ...
      <div className="relative flex justify-center items-center min-h-screen bg-cover bg-center">
        ...
        <div className="relative w-[425px] bg-white  rounded-lg p-6">
          ...
          <div className="text-center mt-4">
            Sign in or
            <Link className="text-blue-600 ml-1" to="/Registration">
              create an account
            </Link>
          </div>
          ...
          <div className="py-3 text-center">
            <Link className="text-blue-600/100" to="/">
              Trở Về Trang Chủ?
            </Link>
          </div>
